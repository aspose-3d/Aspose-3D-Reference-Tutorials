...
type: docs
weight: 10
url: /de/net/3d-scene/change-plane-orientation/
---
## Einführung
...
- Ihr Dokumentenverzeichnis: Richten Sie ein Verzeichnis für Ihre Projektdateien ein.
...
```csharp
// Dadurch wird eine Ebene mit individueller Ausrichtung erstellt
