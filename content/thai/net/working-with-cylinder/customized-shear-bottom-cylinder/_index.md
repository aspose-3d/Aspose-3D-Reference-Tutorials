...
```csharp
cylinder1.ShearBottom = new Vector2(0, 0.83); // แรงเฉือน 47.5 องศาในระนาบ xy (แกน z)
```
...
เพิ่มกระบอกที่สองลงในฉากโดยไม่มีแรงเฉือน:
```csharp
