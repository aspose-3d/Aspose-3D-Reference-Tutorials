...
## Create 3D Extrusion Java क्या है?
...
## लीनियर एक्सट्रूज़न के लिए Aspose.3D का इस्तेमाल क्यों करें?
...
## स्टेप 2: बेस शेप इनिशियलाइज़ करें
...
## स्टेप 3: लीनियर एक्सट्रूज़न करें
...
|---------|--------------|-----|
| `FileNotFoundException` जब सिकुड़ा जा रहा हो | `MyDir` मौजूद नहीं है या लिखने की अनुमति नहीं है | फ़ोल्डर को पहले बनाने या उचित अनुमतियों के साथ एब्सोल्यूट पथ का उपयोग करें। |
...
| ट्विस्ट गलत दिख रहा है | गलत `TwistOffset` मान | `Vector3` कॉर्डिनेट्स को एडजस्ट करें; याद रखें कि ऑफ़सेट ट्विस्ट फ़ोल्डर से पहले लागू होता है। |
