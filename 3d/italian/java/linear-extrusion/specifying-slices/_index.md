...
L'estrusione lineare prende un profilo 2‑D (come un rettangolo) e lo allunga lungo una linea retta per formare un solido 3‑D. Specificando le **fette**, si indica ad Aspose.3D quanti passaggi intermedi si generano, influenzando direttamente la fluidità dei bordi curvi, come un rettangolo arrotondato.

## Perché utilizzare Aspose.3D per Java per creare estrusione 3D?
...
### Passaggio 1: Imposta la scena e definisci il profilo
...
### Passaggio 2: **Crea nodi figli** per ogni estrusione
...
### Passaggio 3: Esegui l'estrusione lineare e **imposta le sezioni**
...
### Passaggio 4: **Esporta OBJ** – salva la scena
...
|-------|----------------|-----|
| **L'estrusione appare piatta** | Il conteggio delle fette è impostato su 1 o 0 | Assicurati che `setSlices` sia chiamato con un valore ≥2
| **Gli angoli arrotondati accompagnato a scalini** | Raggio di arrotondamento troppo piccolo rispetto al conteggio delle fette | Aumenta il raggio o il conteggio delle fette per curva più lisce. |
