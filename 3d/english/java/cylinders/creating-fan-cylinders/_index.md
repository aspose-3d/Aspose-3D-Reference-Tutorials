---
title: Add Child Node to Build Fan Cylinders with Aspose.3D for Java
linktitle: Adding Child Node for Fan Cylinders with Aspose.3D Java
second_title: Aspose.3D Java API
description: Learn how to add child node, position 3D objects, and save the scene as OBJ while creating custom fan cylinders using Aspose.3D for Java.
weight: 10
...
# Add Child Node to Build Fan Cylinders with Aspose.3D for Java

## Introduction

Ready to **add child node** to a 3‑D scene and create eye‑catching fan cylinders? In this tutorial we’ll walk through every step—from setting up the scene, positioning 3D objects, to finally **save scene as OBJ**—using Aspose.3D for Java. Whether you’re polishing a game asset or building a quick prototype, the concepts here will give you solid control over your 3‑D models.
