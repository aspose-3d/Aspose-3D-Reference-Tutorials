...
// Create a bind point to link the property to animation
BindPoint bp = new BindPoint("Translation", new AnimationNode(), translation);
...
Animates the Z axis gives the cube a more dynamic path through 3‑D space.````java
