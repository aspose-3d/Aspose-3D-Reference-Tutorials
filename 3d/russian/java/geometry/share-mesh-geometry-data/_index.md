...
**В: Можно ли экспортировать сцену в форматы, отличные от FBX?**  
О: Да, Aspose.3D поддерживает OBJ, STL, 3MF, GLTF и другие. Достаточно заменить значение перечисления `FileFormat` в вызове `save`.

**В: Как изменить материал после создания сцены?**  
О: Получите узел, измените его `LambertMaterial` (например, `setDiffuseColor`), и снова сохраните сцену.

**В: Эффективно ли библиотека работает с большими mesh‑ами?**  
О: Aspose.3D использует оптимизированные структуры данных; однако для чрезвычайно больших сеток стоит рассмотреть потоковую передачу или разбивку сцены.

**В: Можно ли анимировать изменение цвета?**  
