...
-  Δείγμα 3D μοντέλου: Έχετε ένα τρισδιάστατο μοντέλο σε μορφή FBX που θέλετε να τριγωνοποιήσετε. Μπορείτε να χρησιμοποιήσετε το παρεχόμενο[document.fbx](https://reference.aspose.com/3d/net/) αρχείο για εξάσκηση.
