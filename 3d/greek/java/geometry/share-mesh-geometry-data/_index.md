...
A: Ναι, η Aspose.3D υποστηρίζει OBJ, STL, 3MF, GLTF και άλλα. Απλώς αντικαταστήστε το enum `FileFormat` στην κλήση `save`.

**Q: Τι γίνεται αν χρειαστεί να αλλάξω το υλικό μετά τη δημιουργία της σκηνής;**  
A: Ανακτήστε τον κόμβο, τροποποιήστε το `LambertMaterial` του (π.χ., `setDiffuseColor`) και αποθηκεύστε ξανά τη σκηνή.

**Q: Η βιβλιοθήκη διαχειρίζεται μεγάλα meshes αποδοτικά;**  
A: Η Aspose.3D χρησιμοποιεί βελτιστοποιημένες δομές δεδομένων· ωστόσο, για εξαιρετικά μεγάλα meshes, σκεφτείτε τη ροή δεδομένων ή τη διαίρεση της σκηνής.

**Q: Υπάρχει τρόπος να ανιματοποιήσω την αλλαγή χρώματος;**  
A: Ναι, μπορείτε να ανιματοποιήσετε τις ιδιότητες του υλικού χρησιμοποιώντας το API `AnimationController`.
