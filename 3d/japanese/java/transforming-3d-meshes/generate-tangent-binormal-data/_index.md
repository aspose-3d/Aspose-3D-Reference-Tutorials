...
## よくある質問
### Aspose.3D はさまざまな 3D ファイル形式に対応していますか？
はい、Aspose.3D は FBX、STL、OBJ など幅広い 3D ファイル形式をサポートしています。完全なリストは[ドキュメント](https://reference.aspose.com/3d/java/)をご参照ください。

### 購入前に Aspose.3D を試すことはできますか？
もちろんです！無料トライアルは[こちら](https://releases.aspose.com/)から入手できます。

### Aspose.3D のサポートはどこで得られますか？
質問や支援が必要な場合は、Aspose.3D [フォーラム](https://forum.aspose.com/c/3d/18)をご利用ください。

### Aspose.3D の一時ライセンスはどう取得しますか？
一時ライセンスは[こちら](https://purchase.aspose.com/temporary-license/)から取得できます。

### Aspose.3D はどこで購入できますか？
購入は[こちら](https://purchase.aspose.com/buy)から行えます。
